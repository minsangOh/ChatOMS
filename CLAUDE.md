...
- Phase 1~4는 완료된 기반으로 취급한다.
- 현재 후속 구현 범위는 Phase 5이며, Phase 4의 종료 지점은 `AwaitingUserDiffApproval`이다.
- Phase 5 이후 기능을 선제 구현하지 않는다.
- 구현 전에 현재 코드와 승인된 Phase 5 요구사항 사이의 gap을 먼저 분석한다.
